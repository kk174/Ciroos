#!/bin/bash
# Deploy OpenTelemetry Collector to C1 (us-east-1) cluster

set -e

CLUSTER_NAME="petclinic-c1"
REGION="us-east-1"
CONTEXT="arn:aws:eks:us-east-1:$(aws sts get-caller-identity --query Account --output text):cluster/petclinic-c1"

echo "========================================="
echo "Deploying OpenTelemetry Collector to C1"
...
echo ""
echo "========================================="
echo "✓ OpenTelemetry Collector deployed to C1"
echo "========================================="
echo ""
